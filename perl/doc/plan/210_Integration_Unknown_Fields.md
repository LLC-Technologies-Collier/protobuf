...
*   [x] Tests in `perl/t/c/integration/210_unknown_fields_coro.c` use libcoro to stress concurrent C function usage for unknown_fields. (Note: Coro is used here for C-level stress testing to ensure re-entrancy and safety. The Perl API will aim to be event-loop agnostic.)
