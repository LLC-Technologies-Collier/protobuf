...
bool load_test_descriptors(pTHX_ upb_Arena *arena) {
    ...
    const upb_MessageDef *mdef4 = upb_DefPool_FindMessageByName(test_pool, "protobuf_test_messages.proto2.TestAllTypesProto2.Data");
    cdiag("protobuf_test_messages.proto2.TestAllTypesProto2.Data found: %s", mdef4 ? "YES" : "NO");
